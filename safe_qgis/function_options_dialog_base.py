...
class Ui_FunctionOptionsDialogBase(object):
    def setupUi(self, FunctionOptionsDialogBase):
        FunctionOptionsDialogBase.setObjectName(_fromUtf8(
            "FunctionOptionsDialogBase"))
        FunctionOptionsDialogBase.resize(594, 391)
        self.editableImpactFunctionsButtonBox = QtGui.QDialogButtonBox(
            FunctionOptionsDialogBase)
        self.editableImpactFunctionsButtonBox.setGeometry(
            QtCore.QRect(30, 340, 541, 32))
        self.editableImpactFunctionsButtonBox.setOrientation(
            QtCore.Qt.Horizontal)
        self.editableImpactFunctionsButtonBox.setStandardButtons(
            QtGui.QDialogButtonBox.Cancel | QtGui.QDialogButtonBox.Ok)
        self.editableImpactFunctionsButtonBox.setObjectName(
            _fromUtf8("editableImpactFunctionsButtonBox"))
        ...
        self.editableImpactFunctionsFormLayout = QtGui.QFormLayout(
            self.formLayoutWidget)
        self.editableImpactFunctionsFormLayout.setFieldGrowthPolicy(
            QtGui.QFormLayout.AllNonFixedFieldsGrow)
        self.editableImpactFunctionsFormLayout.setMargin(0)
        self.editableImpactFunctionsFormLayout.setObjectName(_fromUtf8(
            "editableImpactFunctionsFormLayout"))
        ...
        self.impFuncConfLabel.setAlignment(QtCore.Qt.AlignLeading
                                           | QtCore.Qt.AlignLeft
                                           | QtCore.Qt.AlignTop)
        ...
        self.impFuncConfErrLabel.setStyleSheet(_fromUtf8(
            "color: rgb(255, 0, 0)"))
        ...
        self.impFuncConfErrLabel.setObjectName(_fromUtf8(
            "impFuncConfErrLabel"))

        self.retranslateUi(FunctionOptionsDialogBase)
        QtCore.QObject.connect(self.editableImpactFunctionsButtonBox,
            QtCore.SIGNAL(_fromUtf8("accepted()")),
            FunctionOptionsDialogBase.accept)
        QtCore.QObject.connect(self.editableImpactFunctionsButtonBox,
            QtCore.SIGNAL(_fromUtf8("rejected()")),
            FunctionOptionsDialogBase.reject)
        QtCore.QMetaObject.connectSlotsByName(FunctionOptionsDialogBase)

    def retranslateUi(self, FunctionOptionsDialogBase):
        FunctionOptionsDialogBase.setWindowTitle(
            QtGui.QApplication.translate("FunctionOptionsDialogBase",
