...
#
# Created: Tue Feb 12 10:55:19 2013
...
class Ui_ConverterDialogBase(object):
    def setupUi(self, ConverterDialogBase):
        ...
        self.tBtnOpenOuput = QtGui.QToolButton(ConverterDialogBase)
        self.tBtnOpenOuput.setEnabled(True)
        self.tBtnOpenOuput.setGeometry(QtCore.QRect(370, 180, 23, 25))
        self.tBtnOpenOuput.setObjectName(_fromUtf8("tBtnOpenOuput"))
    ...
    def retranslateUi(self, ConverterDialogBase):
        ...
        self.tBtnOpenOuput.setText(QtGui.QApplication.translate("ConverterDialogBase", "...", None, QtGui.QApplication.UnicodeUTF8))
