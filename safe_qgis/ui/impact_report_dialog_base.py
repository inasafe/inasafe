...
class Ui_ImpactReportDialogBase(object):
    def setupUi(self, ImpactReportDialogBase):
        ImpactReportDialogBase.setObjectName(_fromUtf8(
            "ImpactReportDialogBase"))
    ...
    def retranslateUi(self, ImpactReportDialogBase):
        ImpactReportDialogBase.setWindowTitle(QtGui.QApplication.translate(
            "ImpactReportDialogBase",
            "Impact report",
            None,
        ...
        self.groupBox.setTitle(QtGui.QApplication.translate(
            ...
            None,
            QtGui.QApplication.UnicodeUTF8))
        self.analysis_extent_radio.setText(QtGui.QApplication.translate(
            "ImpactReportDialogBase",
            "Analysis extent",
            None,
            QtGui.QApplication.UnicodeUTF8))
        self.current_extent_radio.setText(QtGui.QApplication.translate(
            "ImpactReportDialogBase",
            "Current extent",
            None,
            QtGui.QApplication.UnicodeUTF8))
        self.groupBox_2.setTitle(QtGui.QApplication.translate(
            ...
            None,
            QtGui.QApplication.UnicodeUTF8))
        self.template_chooser.setText(QtGui.QApplication.translate(
            "ImpactReportDialogBase",
            "...",
            None,
            QtGui.QApplication.UnicodeUTF8))
