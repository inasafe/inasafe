...
class KeywordsWizardTest(unittest.TestCase):
    """Test the InaSAFE keywords wizard GUI"""

    def test_Wizard(self):
        """Test how the category selector works"""
        ...
        dialog = KeywordsWizard(PARENT, IFACE, None, layer)

        # step 1 of 6 - select category
        count = dialog.lstCategories.count()
        self.assertTrue( count==expected_category_count,
        ...
        self.assertTrue( count==expected_subcategory_count,
            'Invalid subcategory count! There should be %d while there were: %d'
            % (expected_subcategory_count,count) )
        second_subcategory = dialog.lstSubcategories.item(1).data(Qt.UserRole)
        self.assertTrue( second_subcategory==expected_second_subcategory,
        ...
        self.assertTrue( count==expected_unit_count,
        ...
        self.assertTrue( second_unit==expected_second_unit,
        ...
        self.assertTrue( count==expected_field_count,
        ...
        self.assertTrue( second_field==expected_second_field,
        ...
        self.assertTrue( dialog.pbnNext.isEnabled(), 'Invalid Next button state'
        ...
        self.assertTrue( keywords == expected_keywords,
            'Invalid metadata!\n Was: %s\n Should be: %s' %
...
if __name__ == '__main__':
    suite = unittest.makeSuite(KeywordsWizardTest, 'test')
