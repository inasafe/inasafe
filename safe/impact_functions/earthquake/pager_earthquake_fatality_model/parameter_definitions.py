...
def displacement_rate():
    """Generator for the displacement rate field"""
    field = DictParameter()
    field.is_required = True
...
def calculate_displaced_people():
    """Generator for the calculatedisplaced people selector"""
