...
from safe.impact_functions.earthquake.earthquake_polygon_population\
    .metadata_definitions import EarthquakePolygonPopulationFunctionMetadata
...
class EarthquakePolygonPopulationFunction(ImpactFunction):
    """Impact Function for Volcano Point on Building."""

    _metadata = EarthquakePolygonPopulationFunctionMetadata()

    def __init__(self):
        super(EarthquakePolygonPopulationFunction, self).__init__()
        self.target_field = 'population'
        # AG: Use the proper minimum needs, update the parameters
        self.parameters = add_needs_parameters(self.parameters)

    def run(self, layers=None):
        """Run earthquake population evacuation Impact Function.

        :param layers: List of layers expected to contain where two layers
            should be present.

            * hazard_layer: Vector polygon layer of earthquake hazard zones
            * exposure_layer: Raster layer of population data on the same grid
                as hazard_layer

        Counts number of people exposed to earthquake hazard zone.

        :returns: Map of population exposed to the earthquake hazard zone.
        ...
        table_body.extend([
            TableRow(tr(
                'Map shows the number of people affected in each of earthquake '
                'hazard zones.'))])
        ...
        map_title = tr('People affected by earthquake hazard zone')
        ...
        impact_layer = Vector(
            ...
            name=tr('People affected by earthquake hazard zone'),
