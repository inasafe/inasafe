...
class EarthquakePolygonPopulationFunctionMetadata(ImpactFunctionMetadata):
    """Metadata for EarthquakePolygonPopulationFunctionMetadata.
    ...
    def as_dict():
        ...
        """
        dict_meta = {
            'id': 'EarthquakePolygonPopulationFunction',
            'name': tr('Earthquake Polygon Population Impact Function'),
            ...
            'citations': [],
            'overview': tr(
                'To assess the impacts of each earthquake hazard zone on '
                'population.'),
