# coding=utf-8
"""InaSAFE Disaster risk tool by Australian Aid - Flood Impact on Population
based on OSM Building data.
...
class FloodPeopleInBuildingsImpactFunction(FunctionProvider):
    ...
    class Metadata(ImpactFunctionMetadata):
        ...
        def get_metadata():
            ...
            dict_meta = {
                ...
                'name': tr('Flood People In Buildings Impact Function'),
