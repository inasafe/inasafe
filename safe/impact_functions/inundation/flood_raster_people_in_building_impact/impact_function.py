...
from safe.impact_functions.inundation\
    .flood_raster_people_in_building_impact.metadata_definitions import \
    FloodRasterPeopleInBuildingMetadata
...
class FloodRasterPeopleInBuildingFunction(
    ...
    def __init__(self):
        ...
        super(FloodRasterPeopleInBuildingFunction, self).__init__()
