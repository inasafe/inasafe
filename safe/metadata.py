...
aggregation_name = tr('aggregation')
aggregation_text = tr(
...
exposure_population_name = tr('population')
exposure_population_text = tr(
    'The <b>population</b> describes the people that might be '
    'exposed to a particular hazard.')

exposure_road = 'road'
exposure_road_name = tr('road')
exposure_road_text = tr(
...
exposure_structure_name = tr('structure')
exposure_structure_text = tr(
...
hazard_earthquake_name = tr('earthquake')
hazard_earthquake_text = tr(
...
hazard_flood = 'flood'
hazard_flood_name = tr('flood')
hazard_flood_text = tr(
...
hazard_tephra_name = tr('tephra')
hazard_tephra_text = tr(
...
hazard_tsunami_name = tr('tsunami')
hazard_tsunami_text = tr(
...
hazard_volcano_name = tr('volcano')
hazard_volcano_text = tr(
