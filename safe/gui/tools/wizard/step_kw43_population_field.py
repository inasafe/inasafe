...
class StepKwPopulationField(WizardStep, FORM_CLASS):
    ...
    def is_ready_to_next_step(self):
        ...
        :rtype: bool
        """
        # This step is not compulsory. An airport vector layer have not any
        # population field.
        return True
    ...
    def set_widgets(self):
        ...
        name_field = self.parent.step_kw_name_field.selected_field()
        for field in self.parent.layer.dataProvider().fields():
            field_name = field.name()
            if field_name not in [type_field, name_field]:
