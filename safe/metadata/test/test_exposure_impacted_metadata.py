...
class TestImpactMetadata(TestCase):
    ...
    def test_json_read(self):
        metadata = ExposureImpactedLayerMetadata(EXISTING_IMPACT_FILE)
        with open(EXISTING_IMPACT_JSON) as f:
    ...
    def test_xml_read(self):
        generated_metadata = ExposureImpactedLayerMetadata(
    ...
    def test_xml_to_json_to_xml(self):
        ...
        read_tmp_metadata = ExposureImpactedLayerMetadata(
