...
<qgis version="2.8.1-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="ADDR:HOUSE">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="ADDR:HO_01">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="ADDR:INTER">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{e45beec7-9934-4dd0-9c53-15f37a715af5}">
      <rule filter="TYPE = 'Hospital'" key="{baa2eb6f-602f-4605-b1a9-b2d23bf6aba5}" symbol="0" label="Hospital"/>
      <rule filter="TYPE = 'Place of Worship' OR &#xa;TYPE = 'Place of Worship - Islam' OR &#xa;TYPE = 'Place of Worship - Unitarian' OR&#xa;TYPE = 'Place of Worship - Buddhist'" key="{26494c21-a8df-4a4a-88d2-25aa1f7a03c3}" symbol="1" label="Place of Worship"/>
      <rule filter="TYPE = 'School' OR TYPE = 'University/College'" key="{d0265b96-f2bc-4c40-a9c1-d9fa480b9593}" symbol="2" label="School/University/College"/>
      <rule filter="TYPE = 'Public Building'" key="{e4c3292d-8b7c-4f18-8193-025494aab422}" symbol="3" label="Public Building"/>
