...
<qgis version="2.14.6-Essen" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="depth" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="0" label="0"/>
      <category render="true" symbol="1" value="0.2" label="0.2"/>
      <category render="true" symbol="2" value="0.5" label="0.5"/>
      <category render="true" symbol="3" value="1" label="1"/>
      <category render="true" symbol="4" value="1.1" label="1.1"/>
      <category render="true" symbol="5" value="1.5" label="1.5"/>
      <category render="true" symbol="6" value="2" label="2"/>
      <category render="true" symbol="7" value="2.1" label="2.1"/>
      <category render="true" symbol="8" value="2.5" label="2.5"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="depth"/>
  ...
  <displayfield>depth</displayfield>
  <label>0</label>
  <labelattributes>
