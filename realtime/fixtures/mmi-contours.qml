...
<qgis version="1.9.0-Master" minimumScale="0" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Color" value="RGB"/>
    <property key="labeling/dataDefined/Family" value=""/>
    <property key="labeling/dataDefined/FontTransp" value=""/>
    <property key="labeling/dataDefined/Hali" value="ALIGN"/>
    ...
    <property key="labeling/dataDefined/PositionX" value="X"/>
    <property key="labeling/dataDefined/PositionY" value="Y"/>
    ...
    <property key="labeling/dataDefined/Vali" value="VALIGN"/>
  ...
  <edittypes>
    <edittype editable="1" type="0" name="ALIGN"/>
    <edittype editable="1" type="0" name="ALIGNMENT"/>
    <edittype editable="1" type="0" name="ELEV"/>
    <edittype editable="1" type="0" name="ID"/>
    <edittype editable="1" type="0" name="LEN"/>
    <edittype editable="1" type="0" name="MMI"/>
    <edittype editable="1" type="0" name="RGB"/>
    <edittype editable="1" type="0" name="ROMAN"/>
    <edittype editable="1" type="0" name="VALIGN"/>
    <edittype editable="1" type="0" name="X"/>
    <edittype editable="1" type="0" name="Y"/>
  </edittypes>
  <editform>/Users/timlinux/dev/python/inasafe-dev/realtime/fixtures</editform>
  <editforminit></editforminit>
  <annotationform>/Users/timlinux/dev/python/inasafe-dev/realtime/fixtures</annotationform>
