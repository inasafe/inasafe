...
<qgis version="1.9.0-Master" minimumScale="-4.65661e-10" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          ...
          <prop k="color_expression" v="colour"/>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/BufferColor" value="colour"/>
  ...
  <edittypes>
    <edittype editable="1" type="0" name="colour"/>
    <edittype editable="1" type="0" name="dir_from"/>
    <edittype editable="1" type="0" name="dir_to"/>
    <edittype editable="1" type="0" name="directio_1"/>
    <edittype editable="1" type="0" name="direction_"/>
    <edittype editable="1" type="0" name="dist_to"/>
    <edittype editable="1" type="0" name="distance_t"/>
    <edittype editable="1" type="0" name="id"/>
    <edittype editable="1" type="0" name="mmi"/>
    <edittype editable="1" type="0" name="name"/>
    <edittype editable="1" type="0" name="population"/>
