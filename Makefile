...
jenkins-pylint:
	...
	@echo "----------------------------------"
	rm -f pylint.log
	pylint --output-format=parseable --reports=y --disable=C,R --rcfile=pylintrc --ignore=odict.py,is_help_base.pyi,is_keywords_dialog_base.py,is_options_base.py,is_dock_base.py storage engine gui > pylint.log || :
