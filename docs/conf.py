...
html_theme_path = ['../../inasafe-doc/themes']
...
latex_documents = [
  ('index', 'InaSAFE.tex', u'InaSAFE Documentation',
   u'Tim Sutton', 'manual'),
]
...
texinfo_documents = [
  ('index', 'InaSAFE', u'InaSAFE Documentation',
   u'Tim Sutton', 'InaSAFE', 'One line description of project.',
   'Miscellaneous'),
]
